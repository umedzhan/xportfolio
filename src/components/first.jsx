    ...
    <div className="flex justify-between">
      <div className="max-w-[537px] mt-[74px]">
        <h1 className="text-[32px] font-semibold">
          Karayev Umedjon is a <font className="main-color">front-end</font> and{" "}
          <font className="main-color">back-end</font> developer
        </h1>
      ...
      <div className="relative">
        ...
        <img
          ...
          src="images/iam.png"
        />
        <img className="absolute left-0 top-[84px] z-0" src="icons/Logo.svg" />
